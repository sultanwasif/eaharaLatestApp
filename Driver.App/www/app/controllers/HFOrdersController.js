angular.module("eahara")
    .controller("HFOrdersController", ['$scope', '$state', 'app.config', 'LoginService', 'AuthenticationService', '$ionicLoading', 'ionicToast', '$ionicHistory', 'MainService', '$cordovaSocialSharing',
        function ($scope, $state, config, LoginService, AuthenticationService, $ionicLoading, ionicToast, $ionicHistory, MainService, $cordovaSocialSharing) {
            ...
            $scope.Init = function () {
                ...
                $scope.Orders = [];
                MainService.MEDgetDriverOrdersUnDelivrerd($scope.TokenInfo.EmployeeId).then(function (res) {
            ...
            $scope.MarkDelivered = function (data) {
                ...
                MainService.MEDSaveDelivredFromDriver(data.Id).then(function (res) {
            ...
            $scope.MarkPicked = function (data) {
                ...
                MainService.MEDSavePickedFromDriver(data.Id).then(function (res) {
