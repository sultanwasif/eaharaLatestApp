angular.module("eahara")
    .controller("HFMyOrdersController", ['$scope', '$state', 'app.config', 'LoginService', 'AuthenticationService', '$ionicLoading', 'ionicToast', '$ionicHistory', 'MainService', '$cordovaSocialSharing', '$stateParams',
        function ($scope, $state, config, LoginService, AuthenticationService, $ionicLoading, ionicToast, $ionicHistory, MainService, $cordovaSocialSharing, $stateParams) {
            ...
            $scope.getData = function () {
                ...
                MainService.MEDgetDriverOrdersUnDelivrerdByDay($scope.data).then(function (res) {
